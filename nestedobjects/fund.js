...
function fundTransfer(from_acno, to_acno, amount) {
    if (validateAccountNumber(from_acno) && validateAccountNumber(to_acno)){
            ...
            if(amount>curBal){
                ...
                let curTrans={from:from_acno,amount:amount} 
                let dbTrans={to:to_acno,amount:amount} 
                 users[from_acno].transactions.debitTransactions.push(dbTrans)
                 users[to_acno].transactions.creditTransactions.push(curTrans)
