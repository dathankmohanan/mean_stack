...
//print details of india 
 ...
 let ind=mycountries.find(data=>data.countryname=="India")
// console.log(ind);

let chinacurr=mycountries.find(data=>data.countryname=="China").currencyname
// console.log(chinacurr);
let cr2=mycountries.filter(pop=>pop.population>20000000).countryname
console.log(cr2);